<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\phpstudy\WWW\project1\project1\public/../application/index\view\login\retrieve.html";i:1514381857;s:83:"F:\phpstudy\WWW\project1\project1\public/../application/index\view\public\left.html";i:1509535995;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
                               ...
                               <p> * 下列信息选填，填写两个及以上有效信息才可修改密码 </p>
                                 <div class="am-form-group xa-sm-am-form-group">
                                    ...
                                    <div class="am-u-md-9 am-u-sm-12">
                                        <input type="text" name="name" id="user-name" placeholder="忘记可不填">
                                    </div>
                                </div>
                                <div class="am-form-group xa-sm-am-form-group">
                                    <label for="team-name" class="am-u-md-3 am-u-sm-12 am-form-label">团队名称</label>
                                    <div class="am-u-md-9 am-u-sm-12">
                                        <input type="text" name="name2" id="team-name" placeholder="忘记可不填">
<!--                                        <small>输入你的名字，让我们记住你。</small>-->
                                    </div>
                                </div>
                                 <div class="am-form-group xa-sm-am-form-group">
                                    <label for="team-name" class="am-u-md-3 am-u-sm-12 am-form-label">团队联系电话</label>
                                    <div class="am-u-md-9 am-u-sm-12">
                                        <input type="text" name="phone" id="team-name" placeholder="忘记可不填">
<!--                                        <small>输入你的名字，让我们记住你。</small>-->
                                    </div>
                                </div>
                                <div class="am-form-group xa-sm-am-form-group">
                                    <label for="team-name" class="am-u-md-3 am-u-sm-12 am-form-label">项目名称</label>
                                    <div class="am-u-md-9 am-u-sm-12">
                                        <input type="text" name="project" id="team-name" placeholder="忘记可不填">
<!--                                        <small>输入你的名字，让我们记住你。</small>-->
                                    </div>
                                </div>
                                
                               <div class="am-form-group xa-sm-am-form-group">
                                <label for="project-name" class="am-u-md-3 am-u-sm-12 ">重置密码</label>
                                  </div>
...
<!--                                        <small>输入你的名字，让我们记住你。</small>-->
                                ...
                                <div class="am-form-group" style="text-align: center;">
                                 ...
                                 <button class="btn btn-info am-radius xa-sm-btn" type="submit">提交</button>
                                </div>
